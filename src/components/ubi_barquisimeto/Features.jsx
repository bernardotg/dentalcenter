...
const features = [
  ...
  { name: 'Ortodoncia', description: '' },
  {
    name: 'Prótesis Fijas',
    description: '',
  },
  { name: 'Prótesis Removibles', description: '' },
  
  { name: 'Cirugía Bucal', description: '' },
  { name: 'Estética Dental', description: '' },
  { name: 'Implantes Dentales', description: '' },
]
